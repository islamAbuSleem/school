...
const _routes = [
  {
    name: "attendance",
    path: "/attendance",
    component: () => import('./attendance-BuDPhuxi.mjs')
  },
  {
    name: "bus-tracking",
    path: "/bus-tracking",
    component: () => import('./bus-tracking-DH3QvJnF.mjs')
  },
  {
    name: "classes",
    path: "/classes",
    component: () => import('./classes-D-BBfiCD.mjs')
  },
  {
    name: "curriculum",
    path: "/curriculum",
    component: () => import('./curriculum-BM32MhYO.mjs')
  },
  {
    name: "fees",
    path: "/fees",
    component: () => import('./fees-BL8Zbtlx.mjs')
  },
  {
    name: "prediction",
    path: "/prediction",
    component: () => import('./prediction-CvT0tjn_.mjs')
  },
  {
    name: "progress",
    path: "/progress",
    component: () => import('./progress-CbfRPiCi.mjs')
  },
  {
    name: "reports",
    path: "/reports",
    component: () => import('./reports-DxHkB7vF.mjs')
  },
  {
    name: "students",
    path: "/students",
    component: () => import('./students-GINt6Js-.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-EPVacZdx.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-CpwvoWBZ.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Dij6RmRN.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-BCuMcDYF.mjs'));
