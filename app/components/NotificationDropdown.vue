...
<template>
  <div class="relative">
    ...
    <Transition enter-active-class="transition ease-out duration-200" enter-from-class="opacity-0 translate-y-2"
      ...
      <div v-if="isOpen"
        class="absolute right-0 mt-3 w-80 bg-white rounded-2xl shadow-xl border border-slate-100 overflow-hidden z-[999]">
        ...
        <div class="max-h-96 overflow-y-auto">
          <div v-for="notification in notifications" :key="notification.id" @click="markRead(notification.id)"
            ...
            <div class="flex items-start gap-3">
              <div
                :class="['w-8 h-8 rounded-lg flex items-center justify-center text-xs font-bold flex-shrink-0', getTypeStyles(notification.type)]">
